...
class Qwqer_Express_Model_Carrier_Door extends Mage_Shipping_Model_Carrier_Abstract implements Mage_Shipping_Model_Carrier_Interface {

    protected $_code = 'qwqer_door';
    ...
    public function calculatePrice($address, $qwqerMethod = null)
    {
        ...
        if ($address) {
            ...
            if (!empty($coordinates['data']['coordinates'])) {
                ...
                $params['real_type'] = Qwqer_Express_Helper_Data::DELIVERY_ORDER_REAL_TYPE_DOOR;
